...
class GatewayAdapter(ProtocolAdapter):
    ...
    async def _execute_cctp_transfer(
        ...
        if source_network != Network.ARC_TESTNET:
            try:
                from omniagentpay.utils.gas import check_gas_requirements
    ...
    async def simulate(
        ...
        **kwargs: Any,
        ...
        from omniagentpay.core.cctp_constants import is_cctp_supported
    ...
    async def _mint_usdc(
        ...
        """
        from omniagentpay.core.cctp_constants import get_message_transmitter_v2
