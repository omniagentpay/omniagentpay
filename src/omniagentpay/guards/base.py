...
class Guard(ABC):
    ...
    def bind_storage(self, storage: Any) -> None:  # noqa: B027
    ...
    async def commit(self, token: str | None) -> None:  # noqa: B027
        """Commit reservation (finalize spend)."""
        pass

    async def release(self, token: str | None) -> None:  # noqa: B027
